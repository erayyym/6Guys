...
class OpenAI {
    ...
    func ask(question: String, completion: @escaping (String?) -> Void) {
        ...
        let body: [String: Any] = [
            "model": "gpt-3.5-turbo-0125", // Updated model name here
            "messages": [
                    ["role": "system", "content": "Your system messages, if any."],
                    ["role": "user", "content": question]
                ],
            "max_tokens": 70,
            // "temperature": 0.7 - This line is commented out, uncomment if needed
        ]
